...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _tld) payable ERC721("pekked Name Service", "PNS"){
  ...
  function register(string calldata name) public payable {
    // checks that the name is unregistered
